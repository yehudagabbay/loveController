...
import ResearchCardsSelect from './comp/game/Research/ResearchCardsSelect';
import PerfectDateFlow from './comp/game/PerfectDate/PerfectDateFlow';
...
const linking = {
  ...
  config: {
    screens: {
      ...
      PerfectDateFlow: 'perfect-date/:dateNumber',
    },
  },
};
  ...
  return (
    <NavigationContainer linking={linking}>
      ...
      >
        ...
        <Stack.Screen name="ResearchCardsSelect" component={ResearchCardsSelect} />
        <Stack.Screen name="PerfectDateFlow" component={PerfectDateFlow} />
