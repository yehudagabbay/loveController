    ...
    () =>
      Array.isArray(routePlayers)
        ? routePlayers
            ...
            .slice(0, FAMILY_ROULETTE_MAX_PLAYERS)
        : [],
    [routePlayers],
  );
    ...
    <View style={[styles.screen, isResearchGame && styles.screenResearch]} key={lang}>
      ...
      <PlayerRouletteOverlay
        ...
        maxPlayersReachedLabel={t('common.playerRoulette.maxPlayersReached', {
          defaultValue: `Max ${FAMILY_ROULETTE_MAX_PLAYERS} players`,
          count: FAMILY_ROULETTE_MAX_PLAYERS,
        })}
      ...
      <GameCardModal
        ...
        turnText={t('familyCardsGame.turn.badge', { name: currentPlayerDisplayName })}
        showCardStatusBar
